	...
	return (<>
		...
		<div className="pt-[4.75rem] lg:pt-[5.25rem]" >
			<form onSubmit={handleSubmit} className="max-w-md mt-10 mx-auto">
				<div onChange={handleInputChange} value={formData.floating_email} className="relative z-0 w-full mb-5 group">
					<input type="email" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 appearance-none dark:text-white  dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required />
					<label htmlFor="floating_email" className="placeholder:peer-focus:font-medium absolute text-sm text-white  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-white peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
				</div>

				<div onChange={handleInputChange} value={formData.floating_first_name} className="grid md:grid-cols-2 md:gap-6">
					...
					<div onChange={handleInputChange} value={formData.floating_last_name} className="relative z-0 w-full mb-5 group">
						...
						<label htmlFor="floating_last_name" className="peer-focus:font-medium absolute text-sm text-white dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-white peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Last name</label>
					</div>
				</div>
				<div className="grid items-center md:grid-cols-2 md:gap-6  ">
					<div className="relative z-0 w-32 mb-5 group ">
						<select className="w-52 bg-transparent text-l text-white" onChange={handleInputChange} value={formData.countryCode} name="countryCode" id="">
							<option className=" text-blue-950 bg-[#fafafa]" selected>Country Code</option>
							<option className=" text-blue-950 bg-[#fafafa]" data-countryCode="IN" value="countryCode" selected>India(+91)</option>
							<option className=" text-blue-950 bg-[#fafafa]" data-countryCode="US" value="1" selected>USA (+1)</option>
							<option className=" text-blue-950 bg-[#fafafa]" data-countryCode="SG" value="65" selected>Singapore (+65)</option>
							<option className=" text-blue-950 bg-[#fafafa]" data-countryCode="GB" value="44" selected>UK (+44)</option>
							<optgroup className="text-blue-950 bg-[#fafafa]" label="Other countries">
					...
					<div onChange={handleInputChange} value={formData.floating_phone} className="relative z-0 w-full mb-5 group">
						<input type="tel" pattern="[8-14]" name="floating_phone" id="floating_phone" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required />
						<label htmlFor="floating_phone" className="peer-focus:font-medium absolute text-sm text-white dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-white peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone number</label>
					</div>
				</div>
				<input onChange={handleInputChange} value={formData.filename} type="file" id="myFile" name="filename" required />
				<div>
					<Button type="submit" onClick={refreshPage} className=" mt-8 lg:flex" >
						Submit
					</Button>
					<ToastContainer />
				</div>
