const IntellectualPropertyRights = () => {
    return (
        <div> <section id="intellectual-property-rights" className="mb-8">
            <h1 className="text-2xl font-bold mb-4">2. INTELLECTUAL PROPERTY RIGHTS</h1>
            <h2 className="text-xl font-semibold mb-2">Our intellectual property</h2>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-medium mb-2">You are responsible for what you post or upload:</h3>
            <p className="mb-4">
