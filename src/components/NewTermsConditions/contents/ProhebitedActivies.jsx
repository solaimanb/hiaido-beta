const ProhebitedActivies = () => {
    return (
        <section id="prohibited-activities" className="mb-8">
            <h1 className="text-2xl font-bold mb-4">7. PROHIBITED ACTIVITIES</h1>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>Misuse of cloud automation services.</li>
                <li>Misuse of AI.</li>
                <li>Creating non-free tier resources (applicable for free-tier).</li>
                <li>Not paying the bill on time.</li>
            </ul>
...
export default ProhebitedActivies