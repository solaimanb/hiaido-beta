...
const Contact = () => {
  ...
  return (
    <div className="container bg-dark rounded-2xl bg-gradient-to-r from-black via-orange-400/10 to-black border-orange-500/20 lg:p-10 relative w-full py-10 md:mx-auto text-center border">
      <div className="">
