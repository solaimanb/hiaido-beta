...
const Contact = () => {
  ...
  return (
    <div className="container bg-black/90 rounded-2xl bg-gradient-to-r from-black via-orange-400/5 to-black border-orange-400/10 lg:p-10 relative w-full md:w-[95%] py-10 md:mx-auto text-center border mx-2">
      <div className="">
